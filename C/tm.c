...
int main () {
    ...
    turing_t *t = create(
            ...
            /* transitions */   2,
            /* transition 1 */  "q0", '1', '1', RIGHT, "q0",
            /* transition 2 */  "q0", 'B', '1', STAY, "qf"
            );
    ...
    t = create(
            ...
            /* initial_tape */  0,
            /* transitions */   6,
            /* transition 1 */  "a", '0', '1', RIGHT, "b",
            /* transition 2 */  "a", '1', '1', LEFT, "c",
            /* transition 3 */  "b", '0', '1', LEFT, "a",
            /* transition 4 */  "b", '1', '1', RIGHT, "b",
            /* transition 5 */  "c", '0', '1', LEFT, "b",
            /* transition 6 */  "c", '1', '1', STAY, "halt"
            );
